...
OLLAMA_MODEL = "llama3.1:8.03b-instruct-q4_K_M"
...
def call_ollama(prompt):
    try:
        ...
        print("Sending request to Ollama API:", data)  # 日志输出
        r = requests.post(OLLAMA_URL, json=data, timeout=120)
        r.raise_for_status()  # 如果响应错误会抛出异常
        print("Received response:", r.json())  # 输出返回的响应
